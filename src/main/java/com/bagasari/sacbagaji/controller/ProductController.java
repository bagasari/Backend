...
public class ProductController {
     ...
     */
    @GetMapping("/search")
    public ResponseEntity<Slice<SearchProductResponseDto>> searchProduct(
        ...
        return ResponseEntity.ok(productService.searchProduct(authInfo.getEmail(), keyword, location, pageable, lastId));
    }
    ...
    public ResponseEntity<List<List<SearchFoodInDynamicRangeResponseDTO>>> searchFoodInDynamicRange(@Auth AuthInfo authInfo, @RequestBody SearchFoodInDynamicRangeRequestDTO dto) {
        return ResponseEntity.ok(productService.searchFoodInDynamicRange(authInfo.getEmail(), dto));
    }
    ...
    public ResponseEntity<List<List<SearchFoodInStaticRangeResponseDTO>>> searchFoodInStaticRange(@Auth AuthInfo authInfo, @RequestBody SearchFoodInStaticRangeRequestDTO dto) {
        return ResponseEntity.ok(productService. searchFoodInStaticRange(authInfo.getEmail(), dto));
    }
}
